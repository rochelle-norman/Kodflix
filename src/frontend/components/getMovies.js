...
export default function getMovies() {
    return [
        ...
        { id: 'Bourne identity', title: 'Bourne Identity', img: Bourne, synopsis: "A man is picked up by a fishing boat, bullet-riddled and suffering from amnesia, before racing to elude assassins and attempting to regain his memory."},
