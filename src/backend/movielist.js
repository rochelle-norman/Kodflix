...
const movieList = [
    ...
    { id: 'Stranger-things', img:'stranger', title: 'Stranger Things', synopsis: "When a young boy disappears, his mother, a police chief and his friends must confront terrifying supernatural forces in order to get him back." },
    { id: 'Bourne identity', img:'bourne', title: 'Bourne Identity', synopsis: "A man is picked up by a fishing boat, bullet-riddled and suffering from amnesia, before racing to elude assassins and attempting to regain his memory." },
    ...
    { id: 'Spiderman', title: 'Spiderman', img:'Spiderman', synopsis: "When bitten by a genetically modified spider, a nerdy, shy, and awkward high school student gains spider-like abilities that he eventually must use to fight evil as a superhero after tragedy befalls his family." }
